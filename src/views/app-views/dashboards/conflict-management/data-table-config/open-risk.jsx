...
export const getOpenConflictColumns = (handleConflictDetails) => [
  {
    key: 'projectName',
  ...
  },
  {
    ...
    width: 120,
    render: (_, record) => {
      const statusConfig = CONFLICT_STATUS[record.conflictStatus];
      return (
        <Tag
  ...
  },
  {
    key: 'daysOpen',
    dataIndex: 'daysOpen',
    title: t('table.component.column.daysOpen'),
    align: 'center',
    width: 120
  },
  {
    key: 'createdBy',
    dataIndex: 'createdBy',
    title: t('table.component.column.openedBy'),
    width: 220
  },
  {
    key: 'createdDate',
  ...
  },
  {
    ...
    title: t('table.component.column.lastUpdate'),
    width: 120,
    render: (_, record) => {
      const { lastUpdatedDate } = record;
      return lastUpdatedDate ? moment(lastUpdatedDate).format(DATE_FORMAT_MM_DD_YYYY) : '';
    }
  },
  {
    key: 'details',
