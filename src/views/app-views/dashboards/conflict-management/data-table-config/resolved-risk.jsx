...
export const getResolvedConflictColumns = (handleConflictDetails) => [
  {
    key: 'projectName',
  ...
  {
    key: 'daysTakenToResolve',
    dataIndex: 'daysTakenToResolve',
    title: t('table.component.column.daysTaken'),
    align: 'center',
    width: 180
  },
  {
  ...
  },
  {
    ...
    title: t('table.component.column.resolvedBy'),
    width: 220
  },
  {
    key: 'details',
    ...
    render: (_, record) => {
      ...
      return (
        <Button onClick={() => { handleConflictDetails(conflictId); }} data-i="details-btn">
