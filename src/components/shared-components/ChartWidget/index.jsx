  ...
  const renderChart = () => (
    <div ref={resizeRef}>
      <div
        ...
        <ApexChart height={height} options={options} series={series} type={type} width={width} />
      </div>
    </div>
  );
...
ChartWidget.propTypes = {
  ...
  series: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.string, PropTypes.object])),
  xAxis: PropTypes.arrayOf(PropTypes.string).isRequired,
  customOptions: PropTypes.objectOf(PropTypes.checkPropTypes),
